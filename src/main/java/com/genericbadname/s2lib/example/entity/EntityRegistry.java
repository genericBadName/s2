...
public class EntityRegistry {
    public static final EntityType<ExampleS2Entity> EXAMPLE = Registry.register(BuiltInRegistries.ENTITY_TYPE, S2Lib.asResource("example"), FabricEntityTypeBuilder.Living
